      ...
      <>
         <Container>
                <Row style={{ justifyContent: "center" }} >
                    <Col xs="4" sm="6" lg="10" style={{height: "45vh", minWidth: "240px", marginBottom: "10vh"}} >
                        <Card style={{backgroundColor: "darkred", borderRadius: "40%"}}>
                            <CardBody style={{backgroundColor: "#C4C6D2", borderRadius: "45%", minWidth: "200px", textAlign: "center"}}>
                                ...
                                <CardSubtitle><p>Weight: {props.mass} kg</p></CardSubtitle>
                            </CardBody>
                        </Card>
                    </Col>
                </Row>
